...
class TestBrokerNodeConnection(unittest.TestCase):
    ...
    @staticmethod
    def __init_new_dummy_and_put_resource_on_node(api_key: str, resource, type_resource: str):
        dummy = BrokerNodeDummy(api_key)
        dummy.put_resource_object_on_broker(resource, type_resource)
    ...
    def test_get_broker_node_stats(self):
        stats = self.__create_default_broker_import_stats()
        self.__init_new_dummy_and_put_stats_on_node(self.__DEFAULT_API_KEY, stats)
    ...
    def test_get_broker_node_errors(self):
        ...
        self.__init_new_dummy_and_put_stats_on_node(self.__DEFAULT_API_KEY, error)
    ...
    def test_get_broker_node_errors_missing_repeats(self):
        ...
        self.__init_new_dummy_and_put_stats_on_node(self.__DEFAULT_API_KEY, error1)
        list_errors = self.__BROKER_NODE_CONNECTION.get_broker_node_errors(self.__DEFAULT_NODE_ID)
        self.assertEqual(1, len(list_errors))
        error2 = list_errors[0]
        self.assertEqual('2020-01-01T00:00:00+01:00', error2.timestamp)
    ...
    def test_get_broker_node_versions(self):
        ...
        self.__init_new_dummy_and_put_resource_on_node(self.__DEFAULT_API_KEY, versions, 'versions')
    ...
    def test_get_broker_node_rscript(self):
        ...
        self.__init_new_dummy_and_put_resource_on_node(self.__DEFAULT_API_KEY, rscript, 'rscript')
    ...
    def test_get_broker_node_python(self):
        ...
        self.__init_new_dummy_and_put_resource_on_node(self.__DEFAULT_API_KEY, python, 'python')
    ...
    def test_get_broker_node_import_scripts(self):
        ...
        self.__init_new_dummy_and_put_resource_on_node(self.__DEFAULT_API_KEY, scripts, 'import-scripts')
