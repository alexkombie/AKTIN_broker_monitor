...
docker exec python pytest test_NodeInfoRetriever.py
docker exec python pytest test_NodeErrorRetriever.py
docker exec python pytest test_NodeResourceRetriever.py
